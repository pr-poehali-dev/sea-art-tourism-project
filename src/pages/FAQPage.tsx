...
const faqs = [
  { category: '🗺️ Маршрут', q: 'Что такое «Море искусства»?', a: 'Это автомобильный маршрут по Краснодарскому краю из 12 уникальных точек, посвящённых литературе и кинематографу. От Краснодара до Красной Поляны — 847 км культурных открытий.' },
  ...
  { category: '🤖 Боты', q: 'Что делать, если бот не отвечает?', a: 'Свяжитесь с нами через раздел «Контакты» или напишите на email info@more-iskusstva.ru.' },
