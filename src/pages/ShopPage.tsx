...
const prizes = [
  { id: 1, emoji: '📌', title: 'Значок «Море искусства»', desc: 'Металлический значок с логотипом проекта', points: 150, category: 'Значки', popular: true },
  { id: 2, emoji: '🎒', title: 'Набор наклеек', desc: '10 виниловых наклеек с героями маршрута', points: 200, category: 'Наклейки', popular: true },
  { id: 3, emoji: '🃏', title: 'Открытка «Черноморье»', desc: 'Авторская открытка с видами маршрута', points: 100, category: 'Открытки', popular: false },
  { id: 4, emoji: '☕', title: 'Кружка путешественника', desc: 'Фарфоровая кружка с картой маршрута', points: 500, category: 'Сувениры', popular: false },
  { id: 5, emoji: '👕', title: 'Футболка «Исследователь»', desc: 'Хлопковая футболка с символикой проекта', points: 800, category: 'Одежда', popular: false },
  { id: 6, emoji: '🧳', title: 'Рюкзак путешественника', desc: 'Вместительный рюкзак с принтом маршрута', points: 1200, category: 'Сувениры', popular: false },
  { id: 7, emoji: '📜', title: 'Сертификат участника', desc: 'Именной сертификат прохождения маршрута', points: 300, category: 'Сертификаты', popular: true },
  { id: 8, emoji: '🏆', title: 'Диплом «Мастер маршрута»', desc: 'Эксклюзивный диплом за полное прохождение', points: 2000, category: 'Сертификаты', popular: false },
  { id: 9, emoji: '📸', title: 'Фотокнига маршрута', desc: 'Авторская фотокнига с видами Черноморья', points: 1500, category: 'Сувениры', popular: false },
  { id: 10, emoji: '🎭', title: 'Набор «Киногерой»', desc: 'Хлопушка + значок + наклейки', points: 450, category: 'Наборы', popular: true },
  { id: 11, emoji: '📖', title: 'Набор «Книголюб»', desc: 'Закладки + блокнот + ручка', points: 350, category: 'Наборы', popular: false },
  { id: 12, emoji: '🌟', title: 'VIP-набор', desc: 'Все сувениры + экскурсия в подарок', points: 5000, category: 'Эксклюзив', popular: false },
];
