...
const reviews = [
  { name: 'Семья Ивановых', city: 'Краснодар', text: 'Объехали весь маршрут за две недели! Дети в восторге — особенно понравилась скала из «Бриллиантовой руки». Лучшее семейное путешествие за последние годы!', rating: 5, avatar: '👨‍👩‍👦' },
  ...
  { name: 'Семья Петровых', city: 'Санкт-Петербург', text: 'Отличная идея — объединить кино, литературу и путешествие! Дети были в восторге от Дома Бабы Яги и Дендрария в Сочи. Получили приз СберПрайм — очень довольны!', rating: 5, avatar: '👨‍👩‍👧‍👦' },
  { name: 'Андрей В.', city: 'Екатеринбург', text: 'Проехал маршрут в одиночку за 4 дня. Каждая точка — настоящее открытие. Рекомендую всем, кто любит историю и кино.', rating: 5, avatar: '🧔' },
  { name: 'Семья Новиковых', city: 'Казань', text: 'Были со старшими детьми — 12 и 15 лет. Дети сами пробовали угадать места съёмок фильмов. Дом Короленко в Джанхоте произвёл особое впечатление!', rating: 5, avatar: '👨‍👩‍👦‍👦' },
  { name: 'Ольга С.', city: 'Ростов-на-Дону', text: 'Красивейший маршрут! Собрала 40 баллов и обменяла на VK Музыку. Особенно понравился Олимпийский парк вечером с фонтанами.', rating: 5, avatar: '👩‍🦱' },
];
